...
export function walkSteps(model: Model): WalkStep[] {
  ...
  return [
    {
      id: 'container', eyebrow: 'Step 1 of 6', target: 'BESS',
      title: 'One container',
    ...
    {
      id: 'banks', eyebrow: 'Step 2 of 6', target: 'BESS',
    ...
    {
      id: 'string', eyebrow: 'Step 3 of 6', target: rack,
      title: 'One string',
    ...
    {
      id: 'pack', eyebrow: 'Step 4 of 6', target: pack,
    ...
    {
      id: 'cell', eyebrow: 'Step 5 of 6', target: cell,
      title: 'One cell',
    ...
    {
      id: 'path', eyebrow: 'Step 6 of 6', target: 'BESS',
      title: 'The path out',
